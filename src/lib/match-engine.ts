...
export const MARKETS: MarketConfig[] = [
  ...
  {
    id: 'juvnap', contract: 'JUVNAP/USDT',
    homeTeam: 'Juventus', awayTeam: 'Napoli',
    homeShort: 'JUV', awayShort: 'NAP',
    homeColor: 'hsl(0, 0%, 10%)', awayColor: 'hsl(200, 75%, 50%)',
    startPrice: 1.45,
    scenario: 'tactical',
    homePlayers: ['Vlahović', 'Yıldız', 'Chiesa', 'Locatelli', 'Rabiot', 'Cambiaso', 'Bremer', 'Gatti', 'Danilo', 'McKennie', 'Szczęsny'],
    awayPlayers: ['Kvaratskhelia', 'Osimhen', 'Politano', 'Lobotka', 'Anguissa', 'Di Lorenzo', 'Rrahmani', 'Juan Jesus', 'Mario Rui', 'Zielinski', 'Meret'],
  },
  {
    id: 'avlnwc', contract: 'AVLNWC/USDT',
    homeTeam: 'Aston Villa', awayTeam: 'Newcastle',
    homeShort: 'AVL', awayShort: 'NWC',
    homeColor: 'hsl(280, 60%, 30%)', awayColor: 'hsl(0, 0%, 15%)',
    startPrice: 1.65,
    scenario: 'balanced',
    homePlayers: ['Watkins', 'Bailey', 'Ramsey', 'McGinn', 'Douglas Luiz', 'Cash', 'Konsa', 'Torres', 'Digne', 'Tielemans', 'Martínez'],
    awayPlayers: ['Isak', 'Gordon', 'Almirón', 'Bruno G.', 'Joelinton', 'Trippier', 'Schär', 'Botman', 'Burn', 'Longstaff', 'Pope'],
  },
  {
    id: 'atmvil', contract: 'ATMVIL/USDT',
    homeTeam: 'Atlético Madrid', awayTeam: 'Villarreal',
    homeShort: 'ATM', awayShort: 'VIL',
    homeColor: 'hsl(0, 70%, 45%)', awayColor: 'hsl(50, 90%, 55%)',
    startPrice: 1.30,
    scenario: 'high-press',
    homePlayers: ['Griezmann', 'Morata', 'Llorente', 'Koke', 'De Paul', 'Molina', 'Giménez', 'Hermoso', 'Reinildo', 'Lemar', 'Oblak'],
    awayPlayers: ['Sørloth', 'Moreno', 'Baena', 'Parejo', 'Comesaña', 'Foyth', 'Mandi', 'Albiol', 'Pedraza', 'Pino', 'Reina'],
  },
  {
    id: 'porbra', contract: 'PORBRA/USDT',
    homeTeam: 'Porto', awayTeam: 'Braga',
    homeShort: 'POR', awayShort: 'BRA',
    homeColor: 'hsl(220, 70%, 35%)', awayColor: 'hsl(0, 70%, 45%)',
    startPrice: 1.10,
    scenario: 'home-dominant',
    homePlayers: ['Taremi', 'Galeno', 'Pepê', 'Otávio', 'Uribe', 'João Mário', 'Pepe', 'Marcano', 'Sanusi', 'Eustáquio', 'Diogo Costa'],
    awayPlayers: ['Banza', 'Bruma', 'Horta', 'Al Musrati', 'Castro', 'Gómez', 'Niakhaté', 'Oliveira', 'Borja', 'Pizzi', 'Matheus'],
  },
];
